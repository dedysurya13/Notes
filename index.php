...
<div class="container mt-5">
  <h3>Catatan</h3>
  <input type="text" id="searchInput" class="form-control mb-3" placeholder="Cari catatan..." autocomplete="off">
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <div class="form-group">
          ...
          <input type="text" class="form-control" id="noteTitle" autocomplete="off">
        </div>
        <div class="form-group">
          <label for="noteContent">Catatan</label>
          <textarea id="noteContent" class="form-control" autocomplete="off"></textarea>
        </div>
      </div>
